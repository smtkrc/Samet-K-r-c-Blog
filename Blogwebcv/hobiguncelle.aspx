<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="hobiguncelle.aspx.cs" Inherits="Blogwebcv.hobiguncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="form1" runat="server">
        <div class="form-group">
            ...
            <br />
            <div>
                <asp:Label ID="Label1" runat="server" ForeColor="White" Font-Italic="true" Text="Hobi"></asp:Label>

<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="egitimguncelle.aspx.cs" Inherits="Blogwebcv.egitimguncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     ...
     <form id="form1" runat="server">
        <div class="form-group">
            ...
            <br />
            <div>
                <asp:Label ID="Label6" runat="server" ForeColor="White" Font-Italic="true" Text="Genel Not ortalaması"></asp:Label>

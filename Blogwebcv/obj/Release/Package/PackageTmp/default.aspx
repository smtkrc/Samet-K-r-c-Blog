<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Blogwebcv._default" %>
...
<head>
    ...
    <title>Samet Kürücü Portal</title>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            <span class="d-block d-lg-none">Samet Kürücü</span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#skills">Yetkinliklerim</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#interests">Hobilerim</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#awards">Eğitim ve Sertifikalarım</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#admin">Kullanıcı Bilgileri Düzenle</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container-fluid p-0">
                    ...
                    <div class="my-auto">
                        ...
                        <div class="subheading mb-5">
                            ...
                            <a href="mailto:https://mail.google.com/mail/u/0/#inbox?compose=new">
                                <asp:Label ID="Label5" runat="server" Text="Maile Ulaş"></asp:Label></a>
                            <p></p>
                            <asp:Label ID="Label7" runat="server" Text='<%# Eval("TELEFON") %>'></asp:Label>
                    ...
                    <div class="my-auto">
                        ...
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                <h3 class="mb-0">
                                    <asp:Label ID="Label8" runat="server" Text='<%# Eval("BASLIK") %>'></asp:Label></h3>
                                <div class="subheading mb-3">
                                    <asp:Label ID="Label9" runat="server" Text='<%# Eval("ALTBASLIK") %>'></asp:Label>
                                </div>
                                <p>
                                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("ACIKLAMA") %>'></asp:Label>
                                </p>
                            </div>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
            <div class="my-auto">
                ...
                <div class="subheading mb-3">Programlama dillerim</div>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="awards">
            <div class="my-auto">
                <h2 class="mb-5">Eğitim ve Sertifikalarım</h2>
                <asp:Repeater ID="Repeater6" runat="server">
                    <ItemTemplate>
                        <ul class="fa-ul mb-0">
                            <li>
                                <i class="fa-li fa fa-check text-warning"></i>
                                <asp:Label ID="Label18" runat="server" Text='<%# Eval("ODUL") %>'></asp:Label></li>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="admin">
            <div class="my-auto">
                <h2 class="mb-5">Kullanıcı Paneli Giriş</h2>

                <ul class="fa-ul mb-0">
                    <li>
                        <i class="fa-li fa fa-check text-warning"></i>
                        <asp:HyperLink NavigateUrl="~/girisyap.aspx" ID="HyperLink3" runat="server" CssClass="btn btn-info">Admin Paneli Giriş</asp:HyperLink>
                </ul>
